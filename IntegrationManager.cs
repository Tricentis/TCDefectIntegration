...
namespace TCDefectIntegration {
    ...
    public class IntegrationManager {
        ...
        protected const string TagDefectIntegration = "TCDefectIntegration";
        protected const string TagChangeRequestId = "Log-ChangeRequestId";
        ...
        public virtual int OpenDefect(string dataFileName) {
            ...
            try {
                ...
                reader.Read();
                reader.ReadStartElement(TagDefectIntegration);
                string changeRequestId = reader.ReadElementString(TagChangeRequestId);
        ...
        private List<string> GetDefectIds(string fileName) {
            ...
            try {
                reader = XmlReader.Create(fileName, this.XmlReaderSettings);
                reader.Read();
